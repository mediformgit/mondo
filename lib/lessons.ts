...
export const lessons: Lesson[] = [
  ...
  },
  {
    ...
    body: [
      ...
      },
      {
        ...
        note: "一度に頼むと、AIは“少数の無難な折衷”を返す。広げる→絞るを分けると、飛んだ素材の中から、基準で選び抜ける。",
      },
      {
        t: "callout",
        tone: "warn",
        title: "広げっぱなしも、絞りっぱなしも",
        text:
      ...
      { t: "try", label: "発散→収束を一度に体験する", preset: "diverge-converge" },
      {
        t: "p",
        text:
  ...
  },
  {
    ...
    body: [
      ...
      {
        t: "compare",
        bad: "目標を達成するための計画を立てて。",
        good:
          "最終目標は〜です。立派な計画はいりません。まず“今日、15分でできる最小の一歩”を1つだけ。それが終わったら、また次の一歩を聞きに来ます。",
        note: "前者は、眺めて終わる工程表を生む。後者は、今すぐ手が動く一行を返す。計画は、全部を一度に決めるものではない。",
      },
      { t: "h", text: "計画は、崩れる前提で持つ" },
      {
        t: "p",
        text:
      ...
      { t: "try", label: "「次の最小の一歩」を引き出す問い方を試す", preset: "plan-to-act" },
      {
        t: "p",
        text:
  ...
  {
    slug: "translate-meaning",
    track: "実践",
    num: 22,
    title: "AIを、通訳にする",
    subtitle: "相手とレベルに、言い換える",
    minutes: 9,
    summary:
    ...
    body: [
      ...
      },
      {
        ...
        note: "「分かりやすく」だけでは、最も平均的な言い換えしか返らない。“誰に・何のために・どの長さで”を指定すると、相手に届く一文になる。",
      },
      {
        t: "callout",
        tone: "warn",
        title: "言い換えは、すり替えになりうる",
        text:
      ...
      { t: "try", label: "意味を保ったまま“言い換える”を試す", preset: "translate-meaning" },
      {
        t: "p",
        text:
          "言葉の壁は、難しさの壁でもある。AIを通訳として使えば、その壁は越えられる。ただし、訳が正しいかを確かめるのは、いつでもこちら側の仕事だ。受け取り、確かめ、自分の言葉にする——その往復の中に、問いを立てる力が育つ。",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    body: [
      ...
      },
      {
        ...
        note: "前者は、分かった気で終わる。後者は、思い出し、間違え、直す——身につく回路を回す。",
      },
      { t: "h", text: "三つの役を、振り分ける" },
      {
        t: "list",
        items: [
      ...
      { t: "try", label: "出題→手直しの“練習”を道場で試す", preset: "practice-partner" },
      {
        t: "p",
        text:
  ...
  },
  {
    ...
    body: [
      ...
      {
        t: "compare",
        bad: "今回のプロジェクト、うまくいったよね？",
        good:
          "結果の事実はこれです（…）。設計時の前提のうち、外れたものはどれか。次に同じことをやるなら、最初に変える一手は何か。忖度はいりません。",
        note: "前者は、AIに称賛を買っているだけ。後者は、前提の検証と、次の具体的な一手を引き出す。",
      },
      {
        t: "callout",
        tone: "warn",
      ...
      { t: "try", label: "結果を事実で渡し、次の一手を引き出す", preset: "reflect-after" },
      {
        t: "p",
        text:
          "AIは、これから作るものだけでなく、すでに終えたことにも光を当てられる。過ぎた経験に「次はどう変えるか」と問える人だけが、同じ時間から、より多くを持ち帰る。振り返る問いを立てること——それも、問いを立てる力だ。",
      },
    ],
  },
  {
    ...
    body: [
      ...
      },
      {
        ...
        note: "前者は、無難な“正論”を呼ぶ。後者は、自分では気づけない角度を引き出す。AIに整理させ、判断は自分に残す。",
      },
      { t: "h", text: "何を、人に残すか" },
      {
        t: "p",
      ...
      { t: "try", label: "“整理だけ”を頼む問い方を試す", preset: "talk-it-through" },
      {
        t: "p",
        text:
          "AIに悩みを話すのは、悪いことではない。ただ、AIにできること（整理）と、人にしかできないこと（受け止め）を、自分で分ける。その線を引けることが——道具に飲み込まれず、道具を使うということだ。それもまた、問いを立てる力の一部になる。",
      },
    ],
  },
];
