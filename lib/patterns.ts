...
export const patterns: Pattern[] = [
  ...
  },
  {
    ...
    en: "Ground in Source",
    level: "応用",
    when: "手元の資料・データ・長文に基づいて、正確に答えてほしいとき。AIの“記憶”ではなく、あなたが渡した事実を根拠にさせる。",
    idea:
      "AIは知らないことも“それらしく”埋める。だが「この資料だけに基づいて。書いていなければ『書いていない』と言って」と縛ると、事実と推測がはっきり分かれる。AIの記憶より、あなたが渡した文章のほうが、答えの根拠としては遥かに強い。",
    template:
      "次の資料だけに基づいて{課題}してください。資料に書かれていないことは『資料にない』と明示し、推測で補わないでください。\n\n資料：\n{貼り付け}",
    example:
      "次の資料だけに基づいて答えてください。書かれていないことは『資料にない』と明示し、推測で補わないでください。\n\n資料：『当講座は全6回。第1回のみ無料体験できる。修了証は5回以上の出席で発行。』\n\n質問：①全部で何回？ ②4回の出席で修了証は出る？ ③オンライン受講は可能？",
    preset: "p-ground",
  },
];
